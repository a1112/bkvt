...
import BKVisionTrain.classification
import BKVisionTrain.detection
import BKVisionTrain.segmentation
from BKVisionTrain.base import SingModelAll
from BKVisionTrain.base.property import DetectionProperty, BaseProperty, ImageFolderLoader, \
