...
@register_model
def vit_noisy_t(pretrained=False,optimal=True, res=224,**kwargs) -> NoisyViT:
...
@register_model
def vit_noisy_s(pretrained=False,optimal=True, res=224, **kwargs) -> NoisyViT:
    model = NoisyViT(
        optimal=optimal,
        res=res,
        patch_size=16,
...
@register_model
def vit_noisy_b(pretrained=False,optimal=True, res=224, **kwargs) -> NoisyViT:
    model = NoisyViT(
        optimal=optimal,
        res=res,
        patch_size=16,
...
@register_model
def vit_noisy_l(pretrained=False,optimal=True, res=224, **kwargs) -> NoisyViT:
    model = NoisyViT(
        optimal=optimal,
        res=res,
        patch_size=16,
