...
@register_model
def res18_noisy(optimal=True, res=224, **kwargs) -> NoisyResNet:
    model = NoisyResNet(
        optimal=optimal,
        res=res,
        block=BasicBlock,
...
@register_model
def res34_noisy(optimal=True, res=224, **kwargs) -> NoisyResNet:
    model = NoisyResNet(
        optimal=optimal,
        res=res,
        block=BasicBlock,
...
@register_model
def res50_noisy(optimal=True, res=224, **kwargs) -> NoisyResNet:
    model = NoisyResNet(
        optimal=optimal,
        res=res,
        block=Bottleneck,
...
@register_model
def res101_noisy(optimal=True, res=224, **kwargs) -> NoisyResNet:
    model = NoisyResNet(
        optimal=optimal,
        res=res,
        block=Bottleneck,
