...
parser.add_argument('-c', '--config', default='trainConfig2.yaml', type=str, metavar='FILE',
...
parser.add_argument('data', nargs='?', metavar='DIR',default="", const=None,
                    help='path to dataset (positional is *deprecated*, use --data-dir)')
parser.add_argument('--data-dir',default=r"", metavar='DIR',
...
group.add_argument('--model', default='vit_noisy_patch16_224', type=str, metavar='MODEL',
